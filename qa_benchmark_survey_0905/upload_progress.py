...
HTML = os.path.join(HERE, "LLM설계_QA벤치마크_심층분석_33편_0905.html")
MD   = os.path.join(HERE, "llm-designed-qa-benchmark-survey.md")
...
item = req("POST", "/api/progress", json.dumps({
    "title": "LLM 설계 QA 벤치마크 조사 — 온체인·금융·희소 도메인 (심층 24편 + 요약 9편)",
    "date": "2026-09-05", "status": "DONE", "body": BODY}).encode(),
